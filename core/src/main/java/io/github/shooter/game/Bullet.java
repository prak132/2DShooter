 ...
 * Keeps track of position, velocity, damage, and lifetime.
 */
public class Bullet {
     ...
     * If dirX or dirY are big (over 10), treat them as velocity vector directly,
     * otherwise normalize direction and multiply by default speed.
     * 
     ...
     * Doesn't move if bullet is stopped.
     * 
     ...
     * Usually called when it hits something.
     */
    public void stop() {
        velocity.setZero();
        stopped = true;
